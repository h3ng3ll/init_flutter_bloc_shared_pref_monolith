...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( bool soundStatus)?  update,TResult Function()?  fetch,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Update() when update != null:
return update(_that.soundStatus);case _Fetch() when fetch != null:
return fetch();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( bool soundStatus)  update,required TResult Function()  fetch,}) {final _that = this;
switch (_that) {
case _Update():
return update(_that.soundStatus);case _Fetch():
return fetch();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( bool soundStatus)?  update,TResult? Function()?  fetch,}) {final _that = this;
switch (_that) {
case _Update() when update != null:
return update(_that.soundStatus);case _Fetch() when fetch != null:
return fetch();case _:
...
class _Update implements SettingsEvent {
  const _Update({required this.soundStatus});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Update&&(identical(other.soundStatus, soundStatus) || other.soundStatus == soundStatus));
}
...
@override
String toString() {
  return 'SettingsEvent.update(soundStatus: $soundStatus)';
}
...
/// Create a copy of SettingsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? soundStatus = null,}) {
